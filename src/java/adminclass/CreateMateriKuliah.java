...
public class CreateMateriKuliah extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql1 = "SELECT col_nama_admin FROM tbl_admin WHERE col_nip = ?";
            prepare = koneksi.prepareStatement(sql1);
            prepare.setString(1, idUser);
            
            ResultSet rs1 = prepare.executeQuery();
            while(rs1.next()){
                namaUser = rs1.getString("col_nama_admin");
            }
            ...
            out.println("<script>alert(\'Materi kuliah barhasil disimpan!');window.location.href = \'Admin/MataKuliah.jsp?id-matkul="+kodeMatkul+"\';</script>");
