 ...
 * @author ASUS
 */
@WebServlet(name = "GetAllRequestAdmin", urlPatterns = {"/GetAllRequestAdmin"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement statement = koneksi.prepareStatement("SELECT col_id_req, col_topik_req, col_tgl_req, col_waktu_req, "
                    + "col_status_req FROM tbl_req_materi_kuliah INNER JOIN tbl_mahasiswa ON "+
                    ...
                    "WHERE tbl_admin.col_nip = ? ORDER BY col_id_req DESC");
