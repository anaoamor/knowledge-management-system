    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql1 = "INSERT INTO tbl_respon_req_mk (col_detail_res_req_mk, col_tgl_respon_req_mk, "
                    + "col_waktu_respon_req, col_nip, col_id_req, col_status) VALUES (\'"+respon+"\', now(), now(),\'"+idUser+"\', "+idRequest+", 0)";
            prepare = koneksi.prepareStatement(sql1);
            
            int i = prepare.executeUpdate();
            
            if(i > 0){
                out.println("<script>window.location = \'Admin/RecordRequest.jsp?id-req="+idRequest+"\';</script>");
            }
