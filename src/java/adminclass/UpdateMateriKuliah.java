    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(i > 0 ){
            if(idRequestPage.equals("0")){
                out.println("<script>alert(\'Materi kuliah berhasil diupdate!\');window.location = \'Admin/RecordMateriKuliah.jsp?id-materi="+id+"\';</script>");
            }else
                out.println("<script>alert(\'Materi kuliah berhasil diupdate!\');window.location = \'Admin/RecordMyUpload.jsp?id-materi="+id+"\';</script>");
