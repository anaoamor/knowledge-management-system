 ...
 */
@MultipartConfig
public class UpdateImageStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nip = request.getParameter("id");
        String tipeUser = request.getParameter("tipe-user");
        
        String nextPage = "";
        if(tipeUser.equals("2"))
            nextPage = "KaprodiSI.jsp";
        else
            nextPage = "WadekKemahasiswaan.jsp";
        ...
        if(fileName != "" && (image.getSize() < 102400)){
            ...
            //ALIRAN KELUARAN 
            String lokasiTarget = "C:\\Users\\Asus\\Documents\\Netbeans Projects\\KMSMahasiswaSI\\build\\web\\profil-pict\\"+nip+".png";
            ...
            try{
                ...
                out.println("<script type=\"text/javascript\"> window.location = \'Admin/"+nextPage+"?nip="+nip+"&tipe-user="+tipeUser+"\';</script>");
            }catch(SQLException ex){

                out.println("<html>"+ex.getMessage()+"</html>");
            }
        }else{
            out.println("<script type=\"text/javascript\"> alert(\'Image Invalid!\'); window.location = \'Admin/"+nextPage+"?nip="+nip+"&tipe-user="+tipeUser+"\';</script>");
        }
