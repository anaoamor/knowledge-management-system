 ...
 */
@MultipartConfig
public class UpdateImageMahasiswa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nimMahasiswa = request.getParameter("nim");
        ...
        if(fileName != "" && (image.getSize() < 102400)){
            ...
            //ALIRAN KELUARAN 
            String lokasiTarget = "C:\\Users\\Asus\\Documents\\Netbeans Projects\\KMSMahasiswaSI\\build\\web\\profil-pict\\"+nimMahasiswa+".png";
            ...
            try{
                ...
                statement.setString(2, nimMahasiswa);
                int i = statement.executeUpdate();
                out.println("<script type=\"text/javascript\"> window.location = \'Admin/RecordMahasiswa.jsp?tahun-angkatan="+tahunAngkatan+"&nim="+nimMahasiswa+"\';</script>");
            }catch(SQLException ex){

                out.println("<html>"+ex.getMessage()+"</html>");
            }
        }else{
            out.println("<script type=\"text/javascript\"> alert(\'Image Invalid!\'); window.location = \'Admin/RecordMahasiswa.jsp?tahun-angkatan="+tahunAngkatan+"&nim="+nimMahasiswa+"\';</script>");
        }
