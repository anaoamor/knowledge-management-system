 ...
 * @author ASUS
 */
public class GetAllRegistrasi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //MENDAPATKAN SEMUA MAHASISWA YANG REGISTRASI
        try{
            ...
            String sql = "SELECT col_nim, col_nama_mhs, col_angkatan, tbl_mahasiswa.col_status "+
                    ...
                    "INNER JOIN tbl_pt ON (tbl_pt.col_id_pt = "+
                    "tbl_fakultas.col_id_pt) INNER JOIN tbl_admin ON (tbl_admin.col_id_pt = "+
                    "tbl_pt.col_id_pt) WHERE tbl_admin.col_nip = ? "+
                    "AND tbl_mahasiswa.col_nip IS NULL AND tbl_mahasiswa.col_kode_verifikasi IS NULL";
            ...
            while(rs.next()){
                ...
                m.put("angkatan", rs.getInt("col_angkatan"));
                m.put("status", rs.getInt("col_status"));
                ja.add(m);
            }
