...
public class GetAllFB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //MENDAPATKAN SEMUA FEEDBACK USER ADMIN
        try{
            Connection koneksi = Koneksi.getKoneksi();
            PreparedStatement prepare;
            String sql = "SELECT col_id_fb, col_topik_fb, col_tgl, col_waktu "+
                    "FROM tbl_fb INNER JOIN tbl_mahasiswa ON (tbl_mahasiswa.col_nim = "+
                    "tbl_fb.col_nim) INNER JOIN tbl_prodi_si ON (tbl_prodi_si.col_id_prodi_si = "+
                    ...
                    "WHERE tbl_admin.col_nip = ? ORDER BY col_id_fb DESC";
