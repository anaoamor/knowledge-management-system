 ...
 * @author ASUS
 */
@WebServlet(name = "UpdateProfilKaprodi", urlPatterns = {"/UpdateProfilKaprodi"})
public class UpdateProfil extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql = "UPDATE tbl_kaprodi_si SET col_nip = ?, "+
            ...
            out.println("<script>window.location = \'KaprodiSI/User.jsp\';</script>");
