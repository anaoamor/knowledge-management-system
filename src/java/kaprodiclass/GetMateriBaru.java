 ...
 * @author ASUS
 */
public class GetMateriBaru extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement statement = koneksi.prepareStatement("SELECT "+
                    "col_nama, col_deskripsi, col_upload_by, col_tgl_upload, "+
                    "col_file, col_author_file, col_nama_matkul FROM tbl_materi_kuliah "+
                    "INNER JOIN tbl_matkul ON (tbl_matkul.col_kode_matkul = tbl_materi_kuliah.col_kode_matkul) "
