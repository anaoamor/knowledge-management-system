    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(fileName != "" && (image.getSize() < 102400)){
            ...
            try{
                ...
                out.println("<script type=\"text/javascript\"> window.location = \'WadekKemahasiswaan/User.jsp\';</script>");
            }catch(SQLException ex){

                out.println("<html>"+ex.getMessage()+"</html>");
            }
        }else{
            out.println("<script type=\"text/javascript\"> alert(\'Image Invalid!\'); window.location = \'WadekKemahasiswaan/User.jsp';</script>");
        }
