 ...
 * @author ASUS
 */
public class NotifikasiRegistrasi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql = "SELECT col_nama_mhs, col_nim FROM tbl_mahasiswa INNER JOIN "+
                    ...
                    "tbl_fakultas.col_id_fakultas) WHERE tbl_wadek_kemahasiswaan.col_nip = ? AND "+
                    "tbl_mahasiswa.col_nip IS NULL";
        ...
        jo.put("notifikasiRegistrasi", ja);
