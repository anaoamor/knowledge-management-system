    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql = "SELECT col_nim, col_nama_mhs, col_angkatan, tbl_mahasiswa.col_status "+
                    ...
                    "tbl_prodi_si.col_id_fakultas) INNER JOIN tbl_wadek_kemahasiswaan ON "+
                    "(tbl_wadek_kemahasiswaan.col_id_fakultas = tbl_fakultas.col_id_fakultas) WHERE "+
                    "col_angkatan = ? AND tbl_mahasiswa.col_nip = ?";
            prepare = koneksi.prepareStatement(sql);
            prepare.setString(1, tahunAngkatan);
