...
public class UpdateProfil extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tipeUser.equals("0")){
            ...
            try{
                ...
                statement.setString(12, idUser);
                
                int i = statement.executeUpdate();
                jo.put("sum", i);
                
                out.println("<script type=\"text/javascript\">window.location = \'User.jsp\';</script>");
    ...
    public String getFormatTglLahir(String tglLahir){
        formatTglLahir = tglLahir.substring(6)+String.valueOf(tglLahir.charAt(5))+tglLahir.substring(3,5)+
