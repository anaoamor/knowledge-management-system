 ...
 * @author ASUS
 */
public class DeleteFB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql1 = "DELETE FROM tbl_fb WHERE col_id_fb = \'"+idFB+"\'";
            prepare = koneksi.prepareStatement(sql1);
            int i = prepare.executeUpdate(sql1);
            
            String sql2 = "DELETE FROM tbl_respon_fb WHERE col_id_fb = \'"+idFB+"\'";
