<%-- 
    Document   : RegistrasiMahasiswa
    Created on : Sep 15, 2019, 7:39:42 PM
    Author     : ASUS
--%>
...
<html>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--BUTTON NEW-->
                    <button id="button-register" class="w3-button w3-blue w3-round" onclick="window.location.href = 'Registrasi.jsp';">
    ...
    <script type="text/javascript">
        ...
        /** Memuat Semua Registrasi*/
        var html_registrasi = "<tr><th>NIM</th><th>Nama</th><th>Angkatan</th><th>Status</th></tr>";
        function load_all_registrasi(){
            $.ajax({
                url:"../GetAllRegistrasiAdmin",
                method:"POST",
                data:{},
                dataType:"json",
                success:function(data){
                   if(data.listRegistrasi.length){
                        data.listRegistrasi.forEach(function(item){
                            console.log(item.nim);
                            html_registrasi += "<tr class=\"row-mahasiswa\" onclick=\"location.href = \'RecordRegistrasi.jsp?nim="+item.nim+"\'\">"+
                                "<td>"+item.nim+"</td>"+
                       ...
                       html_registrasi += "<tr class=\"row-mahasiswa\">"+
                               "<td>-</td>"+
                               "<td>-</td>"+
                               "<td>-</td>"+
                               "<td>-</td>"+
                   ...
                   $('#table-mahasiswa').html(html_registrasi);
                }
            });
        }
    </script>
