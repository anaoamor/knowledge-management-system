<%-- 
    Document   : MateriKuliahBaru
    Created on : Sep 18, 2019, 12:08:01 PM
    Author     : ASUS
--%>
...
<html>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--LABEL MATERI KULIAH BARU-->
                    <label id="label-materi-baru">Materi Kuliah Baru</label>
                    
                    <!--DAFTAR MATERI KULIAH BARU-->
                    <ul id="ul-materi-baru">
    ...
    <script type="text/javascript">
        ...
        /** Memuat  Materi Kuliah Baru*/
        var html_materi_baru = '';
        function load_materi_baru(){
            $.ajax({
                url:"../GetAllMateriBaruAdmin",
                method:"POST",
                data:{},
                dataType:"json",
                success:function(data){
                   if(data.listMateriBaru.length){
                       data.listMateriBaru.forEach(function(item){
                           html_materi_baru += "<li class=\"li-materi-baru\">"+ 
                                "<a href=\'RecordMateriBaru.jsp?id-materi="+item.idMateriKuliah+"\'>"+item.namaMatkul+" : "+item.namaMateri+"</a>"+
                            "</li>";
                       });
                   }
                   
                   $('#ul-materi-baru').html(html_materi_baru);
                }
            });
        }
    </script>
