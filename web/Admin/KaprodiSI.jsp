<%-- 
    Document   : KaprodiSI
    Created on : Sep 17, 2019, 6:50:25 AM
    Author     : ASUS
--%>
...
<%
    ...
    tipeKaprodi = request.getParameter("tipe-user");
%>
<html>
    <head>
        ...
        <div id="container">
            ...
            <div id="main">
                    ...
                    <div id="myModal" class="modal">
                        ...
                        <!-- Modal content-->
                         <div class="modal-content">
                            ...
                            <form name="form-img" method="POST" action="../UpdateImageStaff?id=<% out.print(nip);%>&tipe-user=<% out.print(tipeKaprodi); %>" enctype="multipart/form-data">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-staff" method="POST" action="../UpdateStaff?id=<% out.print(nip);%>&tipe-user=<% out.print(tipeKaprodi); %>" onSubmit="return validasi_input(this)">
                        <div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            load_kaprodi('<% out.print(nip); %>', '<% out.print(tipeKaprodi); %>');
