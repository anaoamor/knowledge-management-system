<%-- 
    ...
    Created on : Sep 18, 2019, 7:03:35 PM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--DESKRIPSI PRODI SI-->
                    <form id="form-prodi" method="POST" action="../UpdateProdi?no=3&id-prodi=<% out.print(idProdi); %>" onsubmit="return validasi_input(this)">
                        <div class="div-form">
        ...
        function load_prodi_si(id = ''){
            $.ajax({
                ...
                success:function(data){
                    console.log(id);
                    if(data.nipAdmin == '<% out.print(idUser); %>'){
