<%-- 
    Document   : MataKuliah
    Created on : Sep 17, 2019, 4:42:20 PM
    Author     : ASUS
--%>
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <div id="subheader">
                        ...
                        <!--BUTTON ADD MATERI KULIAH SESUAI MATA KULIAH PT ADMIN-->
                            ...
                            data.listMateri.forEach(function(item){
                                if(item.namaMateri.length > 15){
                                    ...
                                    html_all_materi_kuliah += "<div class=\"div-materi-kuliah\">"+
                                            "<button class=\"opsi-materi-kuliah\" onclick=\"window.location.href=\'RecordMateriKuliah.jsp?id-materi="+item.idMateriKuliah+"\'\"><img src=\"../apps-img/folder.png\"></button>"+
