<%-- 
    Document   : CreatePT
    Created on : Sep 16, 2019, 3:30:19 PM
    Author     : ASUS
--%>
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    <div id="panel-subheader">
                        <label id="label-pt">Perguruan Tinggi</label>
                    </div>
                    
                    <!--FORM CREATE PERGURUAN TINGGI-->
                    <form id="form-pt" method="POST" action="../CreatePT" onsubmit="return validasi_input(this)">
                        <div class="div-form">
                    ...
                    <div class="div-submit-button">
                        <div class="div-button">
                            <input id="button-submit" type="submit" value="SUBMIT" form="form-pt" class="w3-button w3-round w3-blue button-form">
                        </div>
                        <div class="div-button">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#button-cancel').click(function(){
                var konfirmasi = window.confirm("Batalkan pembuatan perguruan tinggi baru?");
                if(konfirmasi){
                    window.location = 'PerguruanTinggi.jsp';
                }
            });
        });
