<%-- 
    ...
    Created on : Sep 16, 2019, 8:20:04 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <div class="div-opsi">
                        <div>
                            <input id="button-ok" type="submit" value="OK" class="w3-button w3-round w3-blue button-form" onclick="window.location.href='RegistrasiMahasiswa.jsp'">
                        </div>
                    </div>
                </div>
            </div>
