<%-- 
    ...
    Created on : Sep 18, 2019, 6:41:13 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-materi-kuliah" method="POST" action="../UpdateMateriKuliahAdmin?no=0" enctype="multipart/form-data" onsubmit="return validasi_input(this)">
                        ...
                        <div class="div-form">
                            ...
                            <div id="div-file-update">
                                <input id="file-update" name="file-update" type="file" accept=".docx, .pptx, .pdf, .wmv, .mpeg, .avi, .mp4, .flv, .wmp">
                            </div>
            ...
            function delete_materi_kuliah(id = ''){
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        window.location = 'MataKuliah.jsp?id-matkul='+data.kodeMatkul;
                    }
                });
            }
