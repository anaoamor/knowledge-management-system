<%-- 
    Document   : WadekKemahasiswaan
    Created on : Sep 17, 2019, 10:25:10 AM
    Author     : ASUS
--%>
...
<%
    ...
    tipeWadek = request.getParameter("tipe-user");
%>
<html>
    <head>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <ul id="nav-samping">
                    ...
                    <li>
                        <a href="UserManagement.jsp" class="current">User Management</a>
                    </li>
                    <li>
                    ...
                    <div id="myModal" class="modal">
                        ...
                        <!-- Modal content-->
                         <div class="modal-content">
                            ...
                            <form name="form-img" method="POST" action="../UpdateImageStaff?id=<% out.print(nip);%>&tipe-user=<% out.print(tipeWadek); %>" enctype="multipart/form-data">
                ...
                <div id="panel-content">
                    ...
                    <input id="button-save" type="submit" name="opsi-edit" value="SAVE" form="form-staff" class="w3-button w3-blue w3-round ">
                    <input id="button-cancel"type="submit" name="opsi-edit" value="CANCEL" class="w3-button w3-blue w3-round "><br/>
                    <form id="form-staff" method="POST" action="../UpdateStaff?id=<% out.print(nip);%>&tipe-user=<% out.print(tipeWadek); %>" onSubmit="return validasi_input(this)">
                        <div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            load_wadek('<% out.print(nip); %>', '<% out.print(tipeWadek); %>');
