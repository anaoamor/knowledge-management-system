<%-- 
    Document   : Mahasiswa
    Created on : Sep 15, 2019, 7:06:20 PM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--Panel Submenu Mahasiswa-->
                    <div class="w3-row-padding">
                        
                       <!--Space Kosong-->
                       <div class="w3-col s8"><label id="label-angkatan">Angkatan</label></div>
                        
                        <!--Button Registrasi-->
                        <div class="w3-col s2">
                            <input id="button-registrasi" type="submit" value="Registrasi Mahasiswa"  class="w3-button w3-blue w3-round" onclick="window.location.href = 'RegistrasiMahasiswa.jsp';">
                        </div>
                        
                    </div>
                    
                    <!--Panel Daftar Angkatan-->
                    <div id="panel-angkatan">
                        <ul id="ul-angkatan">
                            <%! Calendar tanggalAwal; %>
                            <% Calendar tanggal; %>
                            <% tanggalAwal = new GregorianCalendar(2013, 7, 15); %>
                            <% tanggal = Calendar.getInstance(); %>
                            <% 
                                int tahunAwal = tanggalAwal.get(Calendar.YEAR);
                                int tahun = tanggal.get(Calendar.YEAR);
                                while(tahun >= tahunAwal){
                                    out.println("<li class=\'li-angkatan\'><a href=\'MahasiswaAngkatan.jsp?tahun-angkatan="+tahun+"\'>"+tahun+"</a>"+
                                            "</li>");
                                    tahun--;
                                }
                            %>
