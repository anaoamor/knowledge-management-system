<%-- 
    Document   : User
    Created on : Sep 15, 2019, 2:06:57 PM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="img-pane">
                   ...
                   <div id="myModal" class="modal">
                       ...
                       <div class="modal-content">
                           ...
                           <form name="form-img" method="POST" action="../UpdateProfilImageAdmin" enctype="multipart/form-data">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-user" method="POST" action="../UpdateProfilAdmin?id=<% out.print(idUser);%>&tipe=<% out.print(tipeUser); %>" onSubmit="return validasi_input(this)">
                        <div>
