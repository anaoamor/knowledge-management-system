<%-- 
    ...
    Created on : Sep 16, 2019, 9:21:11 AM
    Author     : ASUS
--%>
...
<html>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="img-pane">
                   ...
                   <div id="myModal" class="modal">
                       ...
                       <div class="modal-content">
                           ...
                           <form name="form-img" method="POST" action="../UpdateImageMahasiswa?tahun-angkatan=<% out.print(tahunAngkatan); %>&nim=<% out.print(nim); %>" enctype="multipart/form-data">
                ...
                <div id="panel-content">
                    ...
                    <input id="button-cancel"type="submit" name="opsi-edit" value="CANCEL" class="w3-button w3-blue w3-round ">
                    <input id="button-delete"type="submit" name="opsi-edit" value="DELETE" class="w3-button w3-blue w3-round "><br/>
                    <form id="form-user" method="POST" action="../UpdateMahasiswa?id=<% out.print(nim);%>&tahun-angkatan=<% out.print(tahunAngkatan); %>" onSubmit="return validasi_input(this)">
                        <div>
                            <label class="label-form">NIM</label>
                            <input id="nim" class="unedit-form"  name="nim" type="text" ><br/>
                        </div>
                        <div>
                        ...
                        <div>
                           ...
                           <select id="agama" class="select-form" name="agama" type="text">
                            </select><br/>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select id="pt" class="select-form" name="pt" type="text">
                            </select><br/>
                        </div>
                        <div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#check-edit').click(function(){
                if($(this).prop("checked") === true){
                    ...
                    $('#agama').html("<option value=\"0\"></option>"+
            ...
            $("#button-delete").click(function(){
                var konfirmasi = window.confirm("Hapus akun mahasiswa?");
                if(konfirmasi){
                    delete_mahasiswa('<% out.print(nim); %>', '<% out.print(tahunAngkatan); %>', '3');
                }
            });
        });
            ...
            $.ajax({
                ...
                success:function(data){
                    $('#nim').val(data.nim); 
                        ...
                        $('#agama').html("<option>"+data.agama+"</option>");
                        $('#no_hp').val(data.noHp);
                        $('#alamat').val(data.alamat);
                        $('#pt').html("<option>"+data.pt+"</option>");
                        $('#angkatan').val(data.angkatan);
                        if(data.status == "0"){
                            $('#status').html("<option value='0'>Non-Aktif</option>");
                        }else if(data.status == 1){
                            $('#status').html("<option value='1'>Aktif</option>");
                        }
        ...
        /** Delete Mahasiswa */
        function delete_mahasiswa(nim = '', angkatan = '', no = ''){
        console.log(nim);
            $.ajax({
                url:"../DeleteMahasiswa",
                method:"POST",
                data:{nim: nim, angkatan: angkatan, no: no},
                dataType:"json",
                success:function(data){
                   alert('Akun mahasiswa berhasil dihapus!');
                   window.location = 'MahasiswaAngkatan.jsp?tahun-angkatan='+angkatan;
                }
            });
        }
        ...
        function validasi_input(form){
            ...
            if($('#nim').val() == ""){
                ...
                alert("Perguruan tinggi masih kosong!");
                $('#pt').focus();
                return (false);
            } else if($('#angkatan').val() == ""){
