<%-- 
    Document   : User
    Created on : Aug 29, 2019, 10:53:03 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="img-pane">
                   ...
                   <div id="myModal" class="modal">
                       ...
                       <div class="modal-content">
                           ...
                           <form name="form-img" method="POST" action="../UpdateProfilImageWadek" enctype="multipart/form-data">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-user" method="POST" action="../UpdateProfilWadek?id=<% out.print(idUser);%>&tipe=<% out.print(tipeUser); %>" onSubmit="return validasi_input(this)">
                        <div>
