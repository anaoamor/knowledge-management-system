<%-- 
    ...
    Created on : Aug 15, 2019, 8:32:50 PM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-create-materi-kuliah" method="POST" action="CreateMateriKuliah?id-matkul=<% out.print(kodeMatkul); %>" enctype="multipart/form-data" onsubmit="return validasi_input(this)">
                        <div class="div-form">
