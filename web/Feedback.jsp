...
<html>
                ...
                <div id="panel-content">
                    ...
                    <div class="w3-row-padding">
                       ...
                       <div class="w3-col s9"><label></label></div>
                        ...
                        <div class="w3-col s2">
                            <input id="create-fb" type="submit" value="Create"  class="w3-button w3-blue w3-round" onclick="window.location.href = 'CreateFB.jsp';">
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            load_list_fb('<% out.print(idUser); %>');
        });
        
        /** Memuat Daftar Feedback*/
        var html_fb = '';
        function load_list_fb(id = ''){
            $.ajax({
                url:"GetAllFB",
                method:"POST",
                data:{id: id},
                ...
                success:function(data){
                    if(data.listFB.length){
                        data.listFB.forEach(function(item){
                            html_fb += "<li class=\"li-fb\">"+
                                             "<a href=\'RecordFB.jsp?id-fb="+item.idFB+"\'>"+
                                                 "<strong>"+item.topikFB+"</strong><br>"+
                                                 "<small><small>"+item.tglFB+", "+item.waktu+"</small></small>"+
                                             "</a>"+
                                         "</li>";
                        });
                    }
