<%-- 
    ...
    Created on : Sep 9, 2019, 3:11:48 PM
    Author     : ASUS
--%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            load_all_mata_kuliah();
        });
        
        /** Memuat semua daftar Mata Kuliah Sesuai Kurikulum dari Prodi dimimpin Kaprodi*/
        var html_all_matkul = '';
        function load_all_mata_kuliah(){
            $.ajax({
                url:"../GetAllMataKuliahKaprodi",
                method:"POST",
                data:{},
                dataType:"json",
                        ...
                        data.listMatkul.forEach(function(item){
                            if(item.namaMatkul.length > 15){
                                ...
                                html_all_matkul += "<div class=\"div-mata-kuliah\">"+
                                    "<button class=\"opsi-mata-kuliah\" onclick=\"window.window.location.href=\'RecordMataKuliah.jsp?id-matkul="+item.kodeMatkul+"\'\"><img src=\"../apps-img/folder.png\"></button>"+
                                    "<label>"+label_matkul+"..</label></div>";
                            }else{
                                html_all_matkul += "<div class=\"div-mata-kuliah\">"+
                                    "<button class=\"opsi-mata-kuliah\" onclick=\"window.location.href=\'RecordMataKuliah.jsp?id-matkul="+item.kodeMatkul+"\'\"><img src=\"../apps-img/folder.png\"></button>"+
