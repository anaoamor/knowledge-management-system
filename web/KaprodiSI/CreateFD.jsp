<%-- 
    Document   : CreateFD
    Created on : Sep 13, 2019, 10:07:41 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--FORM CREATE FORUM DISKUSI BARU-->
                    <form id="form-create-fd" method="POST" action="../CreateFD" onsubmit="return validasi_input(this)">
                        <div class="div-form">
                            <label class="label-form">Topik</label>
                            <input id="topik-fd" name="topik-fd" class="input-form" type="text"><br/>
                        </div>

                        <div class="div-form">
                            <label class="label-form">Subbidang</label>
                            <select id="subbidang-fd" name="subbidang-fd" class="select-form" type="text">
                                <option value="0">Pilih</option>
                                <% try{ 
                                    Connection konek = Koneksi.getKoneksi();
                                    PreparedStatement statement = konek.prepareStatement("SELECT col_nama_matkul FROM tbl_matkul;");
                                    ResultSet rs = statement.executeQuery();

                                    while(rs.next()) {
                                       out.print("<option value=\""+rs.getString("col_nama_matkul")+"\">"+rs.getString("col_nama_matkul")+"</option>");
                                    }
                                } catch(SQLException ex) {
                    ...
                    <div class="div-submit-button">
                        <div class="div-button">
                            <input id="button-submit" type="submit" value="SUBMIT" form="form-create-fd" class="w3-button w3-round w3-blue button-form">
                        </div>
                        <div class="div-button">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#button-cancel').click(function(){
                var konfirmasi = window.confirm("Batalkan pembuatan forum diskusi?");
                if(konfirmasi){
        ...
        function validasi_input(form){
            ...
            var konfirmasi = window.confirm("Apakah deskripsi forum diskusi sudah benar?\n\n\n"+
                    "Topik                : "+$('#topik-fd').val()+"\n"+
                    "Subbidang      : "+$('#subbidang-fd').val()+"\n"+
                    "Deskripsi        : \n\t"+$('#deskripsi').val());
            if(konfirmasi){
                return true;
            }else{
