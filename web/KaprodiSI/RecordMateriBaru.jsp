<%-- 
    ...
    Created on : Sep 9, 2019, 8:58:02 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <!--LABEL VERIFIKASI-->
                    <label id="label-verifikasi">Verifikasi</label>
                    ...
                    <% out.print("<form id=\"form-materi-baru\" method=\"POST\" action=\"../VerifikasiMateriBaru?id-materi="+idMateri+"\">"); %> 
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" class="textarea-form" name="deskripsi" type="text"></textarea><br/>
                        </div>
                        <div>
                    ...
                    <div class="div-opsi-verifikasi">
                        <div class="div-button">
                            <input id="button-verify" type="submit" value="VERIFY" form="form-materi-baru" class="w3-button w3-round w3-blue button-form">
                        </div>
                        <div class="div-button">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#button-reject').click(function(item){
                var konfirmasi = window.confirm("Reject materi ini?");
                if(konfirmasi){
                    delete_materi('<% out.print(idMateri); %>');
                }
            });
        ...
        /** Menolak materi kuliah */
        function delete_materi(id = ''){
          
            $.ajax({
                url:"../DeleteMateriBaru",
                method:"POST",
                data:{id: id},
                dataType:"json",
                success:function(data){
                    window.location.href = 'MateriKuliahBaru.jsp';
                }
            });
        }
    </script>
