<%-- 
    Document   : Setelan
    Created on : Jul 20, 2019, 10:30:18 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <div id="panel-setelan">
                        <!--LIST SETELAN-->
                        <ul id="ul-setelan">
                            <li class="li-setelan">
                                <a href="ChangeUserAccount.jsp">Change Username & Password</a>
                            </li>
                            <li class="li-setelan">
                                <a id="a-delete-account">Delete Account</a>
                            </li>
                        </ul>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#a-delete-account').click(function(){
                var konfirmasi = window.confirm("Apakah kamu yakin untuk menghapus akun?");
                if(konfirmasi){
                    $.ajax({
                        url:"DeleteAccount",
                        method:"POST",
