<%-- 
    Document   : SistemInformasi
    Created on : Jul 20, 2019, 10:29:54 AM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <div id="subheader">
                        <!--LABEL PRODI SI-->
                        <label id="label-prodi">Program Studi Sistem Informasi</label>
                    </div>
                    
                    <div id="panel-list-si">
                        <!--LIST PRODI SI-->
                        <ul id="ul-prodi-si">
        ...
        function load_list_prodi(){
            $.ajax({
                ...
                success:function(data){
                   if(data.listProdi.length){
                       data.listProdi.forEach(function(item){
                           html_prodi += "<li class=\"li-prodi-si\">"+ 
                                "<a href=\'RecordProdiSI.jsp?id-prodi="+item.idProdi+"\'>"+item.namaPT+"</a>"+
                            "</li>";
                       });
                   }
                   
                   $('#ul-prodi-si').html(html_prodi);
                }
            });
        }
    </script>
