<%-- 
    Document   : Notifikasi
    Created on : Jul 14, 2019, 4:01:01 PM
    Author     : ASUS
--%>
            ...
            <div id="header">
                ...
                <div class="w3-half w3-row-padding">
                    ...
                    <div class="w3-col s1 w3-padding-16">
                        <a href="HomeMahasiswa.jsp"><span id="home" class="glyphicon glyphicon-home" style="font-size:18px;"></span></a>
                    </div>
                        ...
                        success:function(data){
                            if(data.notifikasi.length){
                                data.notifikasi.forEach(function(item) {
                                 ...
                                 + "</strong><br/>"
                                 + "<small>" + item.detailResponRequestMK
                                 + "<br/>"
                                 + "<small>" + item.datetime
                                 + "</small></small>"
                                 + "</a>"
                ...
                function load_notification_fb(id = '', n = ''){
                    $.ajax({
                        ...
                        success:function(data){
                            if(data.notifikasi.length){
                                data.notifikasi.forEach(function(item) {
                                    var detailResponDisplay = item.detailResponFB;
                                    html_fb += "<li id=\"tipe-notifikasi-nested\">"
                                   + "<a href=\"RecordFB.jsp?id-fb="+item.idFB+"\">"
                                 + "<strong>" + item.topikFB
                                 + "</strong><br/>"
                                 + "<small>" + detailResponDisplay.substring(0, 120)
                                 + "... <br/>"
                                 + "<small>" + item.datetime
                                 + "</small></small>"
                                 + "</a>"
