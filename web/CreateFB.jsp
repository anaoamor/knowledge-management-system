<%-- 
    Document   : CreateFB
    Created on : Aug 26, 2019, 3:30:00 PM
    Author     : ASUS
--%>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="panel-content">
                    ...
                    <form id="form-create-fb" method="POST" action="CreateFB" onsubmit="return validasi_input(this)">
                        <div class="div-form">
                            <label class="label-form">Topik</label>
                            <input id="topik-fb" name="topik-fb" class="input-form" type="text"><br/>
                        </div>
                    ...
                    <div class="div-submit-button">
                        <div class="div-button">
                            <input id="button-submit" type="submit" value="SUBMIT" form="form-create-fb" class="w3-button w3-round w3-blue button-form">
                        </div>
                        <div class="div-button">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#button-cancel').click(function(){
                var konfirmasi = window.confirm("Batalkan feedback?");
                if(konfirmasi){
        ...
        function validasi_input(form){
            if($('#topik-fb').val() == ""){
                alert("Topik feedback masih kosong!");
                $('#topik-fb').focus();
                return false;
            ...
            var konfirmasi = window.confirm("Apakah deskripsi feedback sudah benar?\n\n\n"+
                    "Topik                : "+$('#topik-fb').val()+"\n"+
                    "Deskripsi        : \n\t"+$('#deskripsi').val());
            if(konfirmasi){
                return true;
